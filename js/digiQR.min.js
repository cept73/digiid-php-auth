...
for(var q="function"==typeof Object.defineProperties?Object.defineProperty:function(a,d,c){if(c.get||c.set)throw new TypeError("ES3 does not support getters and setters.");a!=Array.prototype&&a!=Object.prototype&&(a[d]=c.value)},u="undefined"!=typeof window&&window===this?this:"undefined"!=typeof global&&null!=global?global:this,v=["Array","prototype","fill"],w=0;w<v.length-1;w++){var x=v[w];x in u||(u[x]={});u=u[x]}
var y=v[v.length-1],z=u[y],C=z?z:function(a,d,c){var b=this.length||0;0>d&&(d=Math.max(0,b+d));if(null==c||c>b)c=b;c=Number(c);0>c&&(c=Math.max(0,b+c));for(d=Number(d||0);d<c;d++)this[d]=a;return this};C!=z&&null!=C&&q(u,y,{configurable:!0,writable:!0,value:C});
function D(a,d,c){var b=.5*a,k=b*d;d=b-k;for(var l=b+k,n=[],g=0;16>g;g++){var e=function(a,b,d,e,c,h,g,l,m,G,A,B,n,H,I,J){f.beginPath();f.moveTo(a,b);f.lineTo(d,e);f.lineTo(c,h);f.lineTo(g,l);f.arc(m,G,k,A*Math.PI,B*Math.PI);f.lineTo(n,H);f.lineTo(I,J);f.lineTo(a,b);f.closePath();f.fill()},m=function(a,b,d,e,c,h,g,l,m,n,A,B){f.beginPath();f.moveTo(a,b);f.lineTo(d,e);f.lineTo(c,h);f.arc(g,l,k,m*Math.PI,n*Math.PI);f.lineTo(A,B);f.lineTo(a,b);f.closePath();f.fill()},h=document.createElement("canvas");
h.height=h.width=a;var f=h.getContext("2d");f.fillStyle=c;1!=g&&9!=g||m(a,a,b,a,b,l,l,l,1,1.5,a,b);8!=g&&9!=g||m(0,0,b,0,b,d,d,d,0,.5,0,b);4!=g&&6!=g||m(a,0,a,b,l,b,l,d,.5,1,b,0);2!=g&&6!=g||m(0,a,0,b,d,b,d,l,1.5,0,b,a);3==g&&f.fillRect(0,b,a,b);12==g&&f.fillRect(0,0,a,b);10==g&&f.fillRect(0,0,b,a);5==g&&f.fillRect(b,0,b,a);15==g&&f.fillRect(0,0,a,a);7==g&&e(a,a,a,0,b,0,b,d,d,d,0,.5,0,b,0,a);11==g&&e(0,a,a,a,a,b,l,b,l,d,.5,1,b,0,0,0);13==g&&e(a,0,0,0,0,b,d,b,d,l,1.5,0,b,a,a,a);14==g&&e(0,0,0,a,b,
a,b,l,l,l,1,1.5,a,b,a,0);n[g]=h}return n}function E(a){a.beginPath();a.fillStyle="#0066cc";a.arc(0,0,.891,0,2*Math.PI);a.closePath();a.fill();a.beginPath();a.fillStyle="#002352";a.arc(0,0,.709,0,2*Math.PI);a.closePath();a.fill()}
function F(a,d){a.save();0==d?(a.fillStyle="#FFFFFF",a.beginPath(),a.moveTo(.245,-.361),a.lineTo(.27,-.428),a.bezierCurveTo(.273,-.435,.268,-.442,.261,-.442),a.lineTo(.166,-.442),a.lineTo(.136,-.363),a.lineTo(.094,-.363),a.lineTo(.118,-.428),a.bezierCurveTo(.121,-.435,.116,-.442,.109,-.442),a.lineTo(.014,-.442),a.lineTo(-.016,-.363),a.lineTo(-.313,-.363),a.bezierCurveTo(-.327,-.363,-.339,-.356,-.346,-.344),a.lineTo(-.42,-.214),a.lineTo(-.317,-.214),a.lineTo(.134,-.214),a.bezierCurveTo(.152,-.214,
.17,-.211,.187,-.204),a.bezierCurveTo(.221,-.19,.259,-.16,.249,-.091),a.bezierCurveTo(.233,.024,.116,.228,-.139,.231),a.lineTo(-.007,-.111),a.bezierCurveTo(-.002,-.125,-.012,-.14,-.028,-.14),a.lineTo(-.204,-.14),a.lineTo(-.417,.383),a.bezierCurveTo(-.417,.383,-.374,.388,-.307,.388),a.lineTo(-.329,.443),a.lineTo(-.231,.443),a.bezierCurveTo(-.223,.443,-.216,.439,-.213,.431),a.lineTo(-.195,.384),a.bezierCurveTo(-.18,.383,-.166,.381,-.151,.379),a.lineTo(-.175,.443),a.lineTo(-.078,.443),a.bezierCurveTo(-.07,
.443,-.063,.439,-.061,.431),a.lineTo(-.033,.359),a.bezierCurveTo(.127,.323,.298,.243,.4,.076),a.bezierCurveTo(.606,-.26,.392,-.346,.245,-.361),a.closePath(),a.fill()):(a.miterLimit="0",a.save(),a.save(),a.globalAlpha="0.3",a.fillStyle="#FFFFFF",a.beginPath(),a.moveTo(.163,.589),a.bezierCurveTo(.161,.589,.158,.589,.156,.588),a.bezierCurveTo(.066,.562,.008,.526,-.053,.461),a.bezierCurveTo(-.132,.376,-.175,.264,-.175,.144),a.bezierCurveTo(-.175,.045,-.098,-.035,-.001,-.035),a.bezierCurveTo(.095,-.035,
.172,.045,.172,.144),a.bezierCurveTo(.172,.209,.225,.262,.289,.262),a.bezierCurveTo(.353,.262,.406,.209,.406,.144),a.bezierCurveTo(.406,-.085,.223,-.271,-.002,-.271),a.bezierCurveTo(-.162,-.271,-.308,-.174,-.374,-.026),a.bezierCurveTo(-.395,.023,-.407,.08,-.407,.144),a.bezierCurveTo(-.407,.192,-.403,.266,-.369,.363),a.bezierCurveTo(-.364,.379,-.371,.396,-.386,.402),a.bezierCurveTo(-.401,.408,-.417,.4,-.423,.384),a.bezierCurveTo(-.45,.304,-.464,.226,-.464,.144),a.bezierCurveTo(-.464,.072,-.45,.005,
-.425,-.052),a.bezierCurveTo(-.35,-.221,-.184,-.33,-.002,-.33),a.bezierCurveTo(.254,-.33,.462,-.117,.462,.145),a.bezierCurveTo(.462,.244,.384,.324,.289,.324),a.bezierCurveTo(.193,.324,.115,.244,.115,.145),a.bezierCurveTo(.115,.081,.062,.028,-.002,.028),a.bezierCurveTo(-.066,.028,-.119,.081,-.119,.145),a.bezierCurveTo(-.119,.249,-.081,.346,-.014,.419),a.bezierCurveTo(.04,.476,.091,.507,.171,.53),a.bezierCurveTo(.186,.535,.194,.551,.191,.568),a.bezierCurveTo(.187,.58,.176,.589,.163,.589),a.lineTo(.163,
.589),a.lineTo(.163,.589),a.closePath(),a.moveTo(.277,.464),a.bezierCurveTo(.21,.464,.151,.445,.102,.41),a.bezierCurveTo(.018,.349,-.031,.249,-.031,.144),a.bezierCurveTo(-.031,.127,-.018,.114,-.003,.114),a.bezierCurveTo(.012,.114,.025,.128,.025,.144),a.bezierCurveTo(.025,.229,.065,.31,.133,.36),a.bezierCurveTo(.173,.389,.22,.404,.277,.404),a.bezierCurveTo(.291,.404,.313,.402,.336,.398),a.bezierCurveTo(.351,.395,.365,.406,.368,.422),a.bezierCurveTo(.371,.438,.361,.454,.346,.457),a.bezierCurveTo(.312,
.464,.285,.464,.277,.464),a.lineTo(.277,.464),a.lineTo(.277,.464),a.closePath(),a.moveTo(-.126,.577),a.bezierCurveTo(-.134,.577,-.141,.574,-.147,.568),a.bezierCurveTo(-.195,.514,-.222,.481,-.26,.408),a.bezierCurveTo(-.299,.333,-.32,.242,-.32,.144),a.bezierCurveTo(-.32,-.037,-.176,-.183,-.001,-.183),a.bezierCurveTo(.174,-.183,.318,-.037,.318,.144),a.bezierCurveTo(.318,.161,.305,.174,.29,.174),a.bezierCurveTo(.275,.174,.262,.16,.262,.144),a.bezierCurveTo(.262,-.003,.144,-.123,-.001,-.123),a.bezierCurveTo(-.146,
-.123,-.264,-.004,-.264,.144),a.bezierCurveTo(-.264,.231,-.246,.312,-.212,.377),a.bezierCurveTo(-.176,.447,-.151,.478,-.108,.524),a.bezierCurveTo(-.097,.536,-.097,.555,-.109,.567),a.bezierCurveTo(-.112,.574,-.119,.577,-.126,.577),a.lineTo(-.126,.577),a.lineTo(-.126,.577),a.closePath(),a.moveTo(-.479,-.156),a.bezierCurveTo(-.485,-.156,-.491,-.158,-.496,-.161),a.bezierCurveTo(-.509,-.171,-.512,-.19,-.503,-.204),a.bezierCurveTo(-.447,-.289,-.376,-.355,-.291,-.402),a.bezierCurveTo(-.114,-.501,.112,-.502,
.289,-.403),a.bezierCurveTo(.374,-.356,.444,-.29,.501,-.206),a.bezierCurveTo(.511,-.192,.508,-.173,.495,-.164),a.bezierCurveTo(.482,-.155,.465,-.157,.456,-.171),a.bezierCurveTo(.405,-.247,.341,-.307,.264,-.349),a.bezierCurveTo(.103,-.438,-.104,-.438,-.265,-.348),a.bezierCurveTo(-.341,-.305,-.406,-.245,-.455,-.168),a.bezierCurveTo(-.461,-.16,-.47,-.156,-.479,-.156),a.lineTo(-.479,-.156),a.lineTo(-.479,-.156),a.closePath(),a.moveTo(.327,-.474),a.bezierCurveTo(.322,-.474,.318,-.475,.314,-.478),a.bezierCurveTo(.206,
-.538,.112,-.564,.001,-.564),a.bezierCurveTo(-.111,-.564,-.217,-.535,-.313,-.478),a.bezierCurveTo(-.327,-.47,-.343,-.475,-.351,-.49),a.bezierCurveTo(-.358,-.506,-.353,-.523,-.339,-.532),a.bezierCurveTo(-.235,-.594,-.119,-.625,.002,-.625),a.bezierCurveTo(.121,-.625,.227,-.596,.341,-.532),a.bezierCurveTo(.355,-.524,.361,-.506,.354,-.491),a.bezierCurveTo(.346,-.48,.337,-.474,.327,-.474),a.lineTo(.327,-.474),a.lineTo(.327,-.474),a.closePath(),a.fill(),a.restore(),a.save(),a.fillStyle="#FFFFFF",a.beginPath(),
a.moveTo(-.34,-.532),a.bezierCurveTo(-.354,-.523,-.359,-.506,-.352,-.49),a.bezierCurveTo(-.344,-.475,-.328,-.47,-.314,-.478),a.bezierCurveTo(-.217,-.535,-.112,-.564,-.001,-.564),a.lineTo(-.001,-.625),a.bezierCurveTo(-.121,-.625,-.236,-.593,-.34,-.532),a.closePath(),a.fill(),a.beginPath(),a.moveTo(-.29,-.402),a.bezierCurveTo(-.375,-.355,-.446,-.289,-.502,-.204),a.bezierCurveTo(-.511,-.19,-.508,-.172,-.495,-.162),a.bezierCurveTo(-.49,-.158,-.484,-.156,-.478,-.156),a.bezierCurveTo(-.469,-.156,-.46,-.16,
-.456,-.169),a.bezierCurveTo(-.405,-.246,-.341,-.307,-.265,-.349),a.bezierCurveTo(-.184,-.394,-.092,-.416,0,-.416),a.lineTo(0,-.477),a.bezierCurveTo(-.101,-.476,-.202,-.452,-.29,-.402),a.closePath(),a.fill(),a.beginPath(),a.moveTo(0,-.183),a.bezierCurveTo(-.176,-.183,-.319,-.037,-.319,.144),a.bezierCurveTo(-.319,.242,-.298,.332,-.259,.408),a.bezierCurveTo(-.222,.481,-.195,.514,-.147,.567),a.bezierCurveTo(-.141,.574,-.134,.577,-.126,.577),a.bezierCurveTo(-.119,.577,-.112,.574,-.107,.567),a.bezierCurveTo(-.095,
.556,-.095,.537,-.106,.525),a.bezierCurveTo(-.15,.477,-.174,.448,-.21,.378),a.bezierCurveTo(-.245,.312,-.263,.231,-.263,.144),a.bezierCurveTo(-.263,-.003,-.145,-.123,0,-.123),a.lineTo(0,-.123),a.lineTo(0,-.183),a.lineTo(0,-.183),a.closePath(),a.fill(),a.beginPath(),a.moveTo(-.002,-.332),a.bezierCurveTo(-.184,-.332,-.35,-.222,-.425,-.053),a.bezierCurveTo(-.45,.005,-.464,.071,-.464,.144),a.bezierCurveTo(-.464,.226,-.45,.304,-.423,.384),a.bezierCurveTo(-.417,.4,-.401,.407,-.386,.402),a.bezierCurveTo(-.371,
.397,-.365,.379,-.369,.363),a.bezierCurveTo(-.404,.266,-.407,.191,-.407,.144),a.bezierCurveTo(-.407,.081,-.395,.023,-.374,-.026),a.bezierCurveTo(-.308,-.175,-.162,-.271,-.002,-.271),a.bezierCurveTo(-.001,-.271,-.001,-.271,0,-.271),a.lineTo(0,-.332),a.bezierCurveTo(-.001,-.332,-.001,-.332,-.002,-.332),a.closePath(),a.fill(),a.beginPath(),a.moveTo(-.031,.144),a.bezierCurveTo(-.031,.194,-.02,.242,0,.286),a.lineTo(0,.114),a.bezierCurveTo(-.001,.114,-.002,.114,-.003,.114),a.bezierCurveTo(-.019,.114,-.031,
.127,-.031,.144),a.closePath(),a.fill(),a.beginPath(),a.moveTo(-.014,.418),a.bezierCurveTo(-.081,.345,-.119,.247,-.119,.144),a.bezierCurveTo(-.119,.079,-.066,.026,-.002,.026),a.bezierCurveTo(-.001,.026,-.001,.026,0,.026),a.lineTo(0,-.035),a.lineTo(-.001,-.035),a.bezierCurveTo(-.098,-.035,-.175,.045,-.175,.144),a.bezierCurveTo(-.175,.264,-.132,.376,-.053,.46),a.bezierCurveTo(-.035,.48,-.018,.495,0,.51),a.lineTo(0,.432),a.bezierCurveTo(-.005,.427,-.009,.423,-.014,.418),a.closePath(),a.fill(),a.restore(),
a.restore(),a.save(),a.fillStyle="#FFFFFF",a.beginPath(),a.moveTo(.004,.701),a.bezierCurveTo(.004,.704,.002,.706,-.001,.706),a.lineTo(-.001,.706),a.bezierCurveTo(-.003,.706,-.006,.704,-.006,.701),a.lineTo(-.006,-.734),a.bezierCurveTo(-.006,-.737,-.003,-.739,-.001,-.739),a.lineTo(-.001,-.739),a.bezierCurveTo(.002,-.739,.004,-.737,.004,-.734),a.lineTo(.004,.701),a.closePath(),a.fill(),a.restore());a.restore()}
function K(a){function d(a){function b(a,b){if(0>a||a>=h||0>b||b>=h)return 1;if(3==k){var c=(h-1)/2,e=a-c,c=b-c;if(e*e+c*c<=d)return 1}return!m.isDark(a,b)}a=D(f,l,a);for(var d=p/f,d=d*d,c=-1;c<=h;c++)for(var g=-1;g<=h;g++){var n=8*b(g,c)+4*b(g+1,c)+2*b(g,c+1)+b(g+1,c+1);e.drawImage(a[n],(g+.5)*f,(c+.5)*f)}}var c=a.data,b=a.size||200,k=a.logo||0,l=a.r||0,n=a.symbol||0,g="Byte";c==c.replace(/[^0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ \$\%\*\+\-\.\/\:]/g,"")&&(g="Alphanumeric");a=document.createElement("canvas");
a.height=a.width=b;var e=a.getContext("2d"),m=qrcode(0,0<k?"H":"L");m.addData(c,g);m.make();var h=m.getModuleCount(),f=Math.floor(b/h),c=Math.floor((b-h*f)/2);e.save();e.translate(c,c);e.fillStyle="#000000";e.fillRect(0,0,h*f,h*f);var c=f*h/2,p=f,p=5>k?p*Math.min(Math.floor((Math.sqrt(.2*h*h)+1)/2)-.5,.5*(h-16)):7>k?.5*p*(h-1):p*Math.min(1.12*Math.sqrt(h*h*.5)-11.08,.56*h);d("#FFFFFF");e.save();e.transform(p,0,0,p,c,c);e.save();1==k&&(e.beginPath(),e.fillStyle="#FFFFFF",e.rect(-1,-1,2,2),e.closePath(),
e.fill());2==k&&(e.beginPath(),e.fillStyle="#FFFFFF",e.arc(0,0,1,0,2*Math.PI),e.closePath(),e.fill());0<k&&(E(e),F(e,n));e.restore();e.restore();if(5==k||7==k){e.save();e.transform(f,0,0,f,f/2,f/2);e.save();for(var r=0;r<h;r++)for(var t=0;t<h;t++)n=function(a,b){e.fillStyle=b;e.beginPath();e.arc(t,r,a,0,2*Math.PI);e.closePath();e.fill()},5!=k||m.isDark(t,r)||n(.5,"rgba(255,255,255,0.5)"),7==k&&n(.2,m.isDark(t,r)?"#000000":"#FFFFFF");e.restore();e.restore()}6==k&&d("rgba(255,255,255,0.5)");e.restore();
return a.toDataURL("image/jpg")}$.DigiQR={request:function(a,d,c,b,k){return L("digibyte:"+a+"?amount="+d.toFixed(8),c,b,k)},address:L,explorer:function(a,d,c,b){return L("https://digiexplorer.info/address/"+a,d,c,b)},text:L,gen:K,id:function(a,d,c,b){return L(a,d,c,b,1)}};function L(a,d,c,b,k){return K({data:a,size:d,logo:c,r:b,symbol:k})};
